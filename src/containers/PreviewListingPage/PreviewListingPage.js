...
import { LoadingPage, priceData } from '../ListingPage/ListingPage.shared';
import { richText } from '../../util/richText';
import productCss from '../ProductPage/ProductPage.module.css';
import PreviewListingPageProductLayout from './PreviewListingPageProductLayout';
...
/** Stessa logica di ProductPage: ultime N parole in accent. */
...
export const PreviewListingPageComponent = props => {
  ...
  const listingCardStyleHeroPrice = (priceClassName, unitClassName) => (
    <FormattedMessage
  ...
  const richListingTitle = (
    <span>
      {richText(listingTitleStr, {
        longWordMinLength: MIN_LENGTH_FOR_LONG_WORDS_IN_TITLE,
        longWordClass: productCss.longWord,
      })}
    </span>
  );
  const listingIdUuidStr = listing.id?.uuid || '';
