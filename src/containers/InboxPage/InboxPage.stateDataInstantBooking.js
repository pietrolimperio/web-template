...
// Get UI data mapped to specific transaction state & role for instant-booking
export const getStateDataForInstantBookingProcess = (txInfo, processInfo) => {
